<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
            ...
            $rows = query("update occupation set occupation=?, notes=?, user_id=?, changed=CURRENT_TIMESTAMP() where id=?",
				...
				{
					render("../view/occupation_update_form.php", ["title" => "Update Occupations", "form_id" => "$rec_id", "message" => "Update was successful."]);        
        		}
    }
    else
    {
		...
		$_SESSION["rec_id"] = $id;
      render("../view/occupation_update_form.php", ["title" => "Update a Occupations",
            "form_id" => "$id", "message" => ""]);
    }
