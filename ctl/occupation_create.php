<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
      ...
      render("../view/occupation_form.php", ["title" => "List of Occupationss", "message" => "$message"]);
    }
    else
    {
      render("../view/occupation_create_form.php", ["title" => "Record Details of a new Occupations"]);
    }
