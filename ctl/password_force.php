    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
      if($_SESSION["user_role"] == "STAFF" | $_SESSION["user_role"] == "ADMIN") {
        ...
        if (count($rows) == 1)
        {
            ...
            render("../view/search_form.php", ["title" => "Password change confirmation",
                "message" => $message]);
        }
        else
        {
      ...
      else {apologize("Only Staff of the Kowie Museum can force password changes.");}
    }
    else
    {
        // else render form
        render("../view/password_force_form.php", ["title" => "Force change of Password",
            "message" => ""]);
    }
