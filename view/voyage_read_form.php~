<?php
	...
	$data = query("SELECT a.*, d.ship_name, b.place origin, c.place dest, a.notes from voyage a, places b, places c, ship d where d.id = a.ship_id and a.origin = b.id and a.destination = c.id and a.id = ? order by ship_name, voyage_date",
						$voyage_id); 
...
<h2>Read about a Voyage</h2>
  <div class="container">
   <table border="0" cellpadding="0" cellspacing="10" width="100%">
	      ...
	      <tr>
				<td align="right" width="30%">Voyage date:</td>
				<td width="2%"></td>
				<td align="left" width="70%"><?php echo $voyage_date; ?></td>
	      </tr>
	      <tr>
